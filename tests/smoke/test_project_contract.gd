...
func test_public_identity_and_portrait_window_are_pinned() -> void:
    ...
    equal(ProjectSettings.get_setting("application/config/version"), "0.4.2", "Public version")
    equal(
...
func test_android_identity_and_offline_export_contract_are_pinned() -> void:
    ...
    equal(config.count('version/name="0.4.2"'), 2, "Android exports use the public version")
    equal(config.count("version/code=14"), 2, "Android exports share the Play version code")
